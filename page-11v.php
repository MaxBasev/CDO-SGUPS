...
?>
	...
	<nav>
	  <ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">11 В</li>
	  </ol>
	</nav>
...
<div class="container-fluid contHeader">	
	...
	<div class="row flex-nowrap justify-content-between align-items-center classHeaderDouble">	  
		<div class="col-12 classHeaderText">11 В</div>					
	</div>
...
<?php	
	$blogusers = get_users('blog_id=1&role=11v');
